...
const Userpage = () => {
    ...
    const convertToExcel = (data) => {
        try {
            ...
            const wscols = Object.keys(wsData[0] || {}).map(key => ({
                wch: Math.max(key.length, ...wsData.map(row => (row[key] ? String(row[key]).length : 0))) + 2
            }));
            ws['!cols'] = wscols;
    ...
    const filteredUsers = sortedUsers.filter(item => {
        ...
        const matchesStatus = statusFilter === 'all' || 
            ...
            (statusFilter === 'inactive' && (itemStatus === 'inactive' || !item.status));
                    ...
                    <div className="bg-gradient-to-r from-[#ff5528] via-[#ff7d5a] to-[#ff5528] px-6 py-8 relative overflow-hidden">
                        ...
                        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div className="transform transition-all duration-300 hover:scale-105">
                                <h1 className="text-4xl font-bold text-white tracking-tight drop-shadow-lg">User Management</h1>
                                <p className="mt-2 text-white/90 text-lg">Manage your users efficiently</p>
                            </div>
                            <div className="flex flex-wrap gap-3">
                                ...
                                >
                                    {isExporting ? (
                                        ...
                                        <>
                                            <svg className="w-4 h-4 transform group-hover:translate-y-[-2px] transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="relative">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="p-3 bg-gradient-to-br from-[#ff5528]/20 to-[#ff7d5a]/20 rounded-full group-hover:from-[#ff5528]/30 group-hover:to-[#ff7d5a]/30 transition-all duration-300">
                                        <svg className="w-6 h-6 text-[#ff5528]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="bg-gradient-to-br from-[#343434] to-black p-4 rounded-lg border border-[#ff5528]/20 hover:border-[#ff5528]/40 transition-all duration-300 group hover:scale-105 transform hover:translate-y-[-2px]">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-white mt-1">{data.filter(user => user.status === "Active").length}</p>
                                </div>
                                <div className="p-3 bg-gradient-to-br from-[#ff5528]/20 to-[#ff7d5a]/20 rounded-full group-hover:from-[#ff5528]/30 group-hover:to-[#ff7d5a]/30 transition-all duration-300">
                                    <svg className="w-6 h-6 text-[#ff5528]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="bg-gradient-to-br from-[#343434] to-black p-4 rounded-lg border border-[#ff5528]/20 hover:border-[#ff5528]/40 transition-all duration-300 group hover:scale-105 transform hover:translate-y-[-2px]">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-white mt-1">{new Set(data.map(user => user.category)).size}</p>
                                </div>
                                <div className="p-3 bg-gradient-to-br from-[#ff5528]/20 to-[#ff7d5a]/20 rounded-full group-hover:from-[#ff5528]/30 group-hover:to-[#ff7d5a]/30 transition-all duration-300">
                                    <svg className="w-6 h-6 text-[#ff5528]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-white mt-1">
                                        {Object.values(userActivity).filter(activity => activity.status === "active").length}
                                    </p>
                                </div>
                                <div className="p-3 bg-gradient-to-br from-[#ff5528]/20 to-[#ff7d5a]/20 rounded-full group-hover:from-[#ff5528]/30 group-hover:to-[#ff7d5a]/30 transition-all duration-300">
                                    <svg className="w-6 h-6 text-[#ff5528]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1 w-full">
                                    <div className="relative group">
                                        ...
                                        <div className="absolute left-3 top-2.5">
                                            <svg className="h-5 w-5 text-[#ff5528] transform group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <table className="min-w-full divide-y divide-[#ff5528]/20">
                                ...
                                <tbody className="bg-[#343434] divide-y divide-[#ff5528]/20">
                                    {filteredUsers.map((item, index) => (
                                        <tr key={index} className="hover:bg-black/30 transition-all duration-200 group relative">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span className={`px-3 py-1 inline-flex items-center gap-1.5 text-xs leading-5 font-semibold rounded-full ${getStatusColor(item.status)}`}>
                                                    ...
                                                    {item.status && item.status.toLowerCase() === 'active' ? 'Active' : 'Inactive'}
                                                </span>
                                            </td>
                    ...
                    <div className="bg-[#343434] px-6 py-4 border-t border-[#ff5528]/20 relative">
                        ...
                        <div className="relative flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="text-sm text-gray-300">
                                Showing <span className="font-medium text-white">{filteredUsers.length}</span> of <span className="font-medium text-white">{data.length}</span> results
                            </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="space-y-4">
                                <div className="bg-black/30 rounded-lg p-4">
                                    <h3 className="text-lg font-medium text-white mb-2">{selectedUser.name}</h3>
                                    <div className="space-y-2">
                                        <p className="text-sm text-gray-300">
                                            <span className="text-gray-400">Status:</span>{' '}
                                            {isClient ? (
                                                <span className={`${userActivity[selectedUser.id]?.status === 'active' ? 'text-green-500' : 'text-yellow-500'}`}>
                                        ...
                                        <p className="text-sm text-gray-300">
                                            ...
                                            {isClient ? (
                                                ...
                                                new Date(userActivity[selectedUser.id].lastActive).toLocaleString() : 
                                                'N/A'
                                            ) : 'Loading...'}
                                        </p>
                                        <p className="text-sm text-gray-300">
